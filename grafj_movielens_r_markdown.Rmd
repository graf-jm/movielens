...
```{r Plot - Ratings: counts by variable, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8}
...
```{r, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8}
...
```{r Plot - Rating count by year of rating, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8}
...
```{r Plot - Rating count by year of release, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8}
...
```{r user, movie & genre, echo=TRUE, include=TRUE}
# Mean rating of all movies
mu_hat <- mean(train_edx$rating)
# Calculating mean by movie
movie_avgs <- train_edx %>%
...
```{r Final model - validation, echo=TRUE, include=TRUE}
# Mean of all movies
